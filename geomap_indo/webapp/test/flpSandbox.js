					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GeoMap Indonesia",
									"targetURL": "#geomapindo-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"geomapindo-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=geomapindo",
									"url": sap.ui.require.toUrl("geomapindo")
								}
							}
						}
					}
